...
./RUN_FreeRTOS.sh -x 5 -y 5 -m chronos2 -s c_testing -n SIMULATION_1 -t 999999999 & 
pid5=$!
sleep 2m
./RUN_FreeRTOS.sh -x 6 -y 6 -m chronos2 -s c_testing -n SIMULATION_1 -t 999999999 &
pid6=$!
sleep 2m
./RUN_FreeRTOS.sh -x 7 -y 7 -m chronos2 -s c_testing -n SIMULATION_1 -t 999999999 &
pid7=$!
sleep 2m
./RUN_FreeRTOS.sh -x 8 -y 8 -m chronos2 -s c_testing -n SIMULATION_1 -t 999999999 &
pid8=$!
sleep 2m
./RUN_FreeRTOS.sh -x 10 -y 10 -m chronos2 -s c_testing -n SIMULATION_1 -t 999999999 &
pid10=$!
sleep 2m
