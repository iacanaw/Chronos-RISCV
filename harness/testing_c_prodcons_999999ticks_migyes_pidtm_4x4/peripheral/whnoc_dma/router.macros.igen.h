...
#define LOCALPORT_REGS_POFFSET          0x0
#define LOCALPORT_REGS_MYADDRESS_POFFSET  0x0
#define LOCALPORT_REGS_MYADDRESS        (LOCALPORT + LOCALPORT_REGS_POFFSET + LOCALPORT_REGS_MYADDRESS_POFFSET)
