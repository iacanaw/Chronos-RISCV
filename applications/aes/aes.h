...
static char round0_print[]="ROUND 0 finished.\n";
static char roundfinal_print[]="ROUND Final finished.\n";
static char barra_ene[]="   \n";
#ifdef debug_aes_on	
static char AddRoundKey_print[]="AddRoundKey: ";
static char SubBytes_print[]="SubBytes: ";
static char InvSubBytes_print[]="InvSubBytes: ";
static char ShiftRows_print[]="ShiftRows: ";
static char InvShiftRows_print[]="InvShiftRows: ";
static char MixColumns_print[]="MixColumns: ";
static char InvMixColumns_print[]="InvMixColumns:";
#endif
...
#ifdef debug_aes_on	
	sys_Prints(&AddRoundKey_print);
	for(i=0; i<4;i++){
		for(j=0; j<4;j++){
			sys_Printi(state[j][i]);		
		}
	}
...
#ifdef debug_aes_on	
	sys_Prints( &barra_ene );
	sys_Prints(&InvMixColumns_print);
	for(i=0; i<4;i++){
		for(j=0; j<4;j++){
			sys_Printi(state[j][i]);
		}
...
void aes_memcpy(void *dest, void *src, int n){
    int i;
    n = n / 4;
