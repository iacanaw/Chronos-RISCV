...
def violin_batch_peak(folders):
    ...
    ax.set_ylabel(r'Peak Temperature in °C')
    ...
    fig.savefig("simulation/"+name+"_VIOLIN_PEAKTEMP.png", format='png', dpi=300, bbox_inches='tight')
    fig.savefig("simulation/"+name+"_VIOLIN_PEAKTEMP.pdf", format='pdf', bbox_inches='tight')
    #plt.show()
