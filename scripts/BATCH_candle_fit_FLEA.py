...
def violin_batch_FLEA(folders):
    plt.rcParams['font.family'] = 'serif'
    plt.rcParams['font.serif'] = ['Times New Roman'] + plt.rcParams['font.serif']

    fig, ax = plt.subplots(figsize =(1.1*4, 2.866))
    ...
    colors = ["#4776EE", "#1BD0D5", "#61FC6C", "#D2E935", "#FE9B2D", "#DA3907"]
    ...
    fig.savefig("simulation/"+name+"_FLEA_FIT.png", format='png', dpi=300, bbox_inches='tight')
    fig.savefig("simulation/"+name+"_FLEA_FIT.pdf", format='pdf', bbox_inches='tight')
    #plt.show()
